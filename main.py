...
DOWNLOAD_DIRECTORY = "C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python38-32\\College_Management_System_Minor_Project_By_Amit_and_Yashvardhan\\uploads\\"
@app.route('/download/<file>')
def down(file):
   print(file)
   return send_from_directory(DOWNLOAD_DIRECTORY, file, as_attachment=True)
app.config['UPLOAD_FOLDER'] = 'C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python38-32\\College_Management_System_Minor_Project_By_Amit_and_Yashvardhan\\uploads'
